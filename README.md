...
3. Open a git folder from File or the workspace control. Kronos indexes it locally. Chat can search, read, and write files inside that folder. View → Terminal runs a command in that folder.
