...
3. Chat is ready without a folder. Open a git folder from File or the workspace control when you want indexing and file edits. AGENTS.md, .cursorrules, and files under .cursor/rules in that folder are followed on every chat turn.
