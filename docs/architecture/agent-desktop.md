...
- Files edits one text file at a time. There is no tabbed IDE. Line numbers sit beside the text. Common languages are colored. Ctrl+F finds in the open file. Ctrl+H replaces in the open file. Ctrl+G jumps to a line.
