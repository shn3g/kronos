...
- Application menu: File, Edit, View, Help. File holds New chat, Open workspace, Go to file, Save, Models, and Settings. Edit is Cut, Copy, Paste, Select all, and Find.
...
- Files edits one text file at a time. There is no tabbed IDE. Line numbers sit beside the text. Common languages are colored. Ctrl+F finds in the open file.
