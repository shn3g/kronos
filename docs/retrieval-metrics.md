...
Klikday recall tests encoded product-specific booking/accessibility score boosts. Kronos does not ship query-specific constants. Golden retrieval uses fixture lessons without those hacks.
