...
"""Freeze Kronos autonomy. Klikday wrappers stay as the operator fallback."""
...
def rollback_to_wrappers(repos: RepositoryService, repo_id: RepositoryId) -> RollbackPlan:
    ...
    return RollbackPlan(
        ...
        fallback="klikday wrappers remain the operator fallback; do not re-enable write crons",
    )
