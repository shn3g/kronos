...
class ProceduralStore:
    ...
    def import_klikday_lessons(self, text: str) -> tuple[MemoryRecord, ...]:
        imported: list[MemoryRecord] = []
        for item in parse_klikday_lessons(text):
            ...
            record = MemoryRecord(
                ...
                provenance={"source_pr": source_pr, "import": "klikday"},
            )
            persist_record(self._conn, record, self._embeddings)
...
def parse_klikday_lessons(text: str) -> tuple[dict[str, object], ...]:
